...
KC.LALT, KC.LGUI, KC.LCTL, KC.LSFT, KC.NO, KC.NO, KC.LSFT, KC.LCTL, KC.LGUI, KC.LALT,
KC.NO, KC.LSFT(KC.DEL), KC.LCTL(KC.INS), KC.LSFT(KC.INS), KC.NO, KC.NO, KC.LSFT(KC.INS), KC.LCTL(KC.INS), KC.LSFT(KC.DEL), KC.NO,
...
KC.LALT, KC.LGUI, KC.LCTL, KC.LSFT, KC.NO, KC.LEFT, KC.DOWN, KC.UP, KC.RGHT, KC.TD(KC.CW, KC.CAPS, tap_time=200),
...
[
KC.TD(KC.NO, KC.RELOAD, tap_time=200), KC.TD(KC.NO, KC.DF(2), tap_time=200), KC.TD(KC.NO, KC.DF(1), tap_time=200), KC.TD(KC.NO, KC.DF(0), tap_time=200), KC.NO, KC.NO, KC.LSFT(KC.INS), KC.LCTL(KC.INS), KC.LSFT(KC.DEL), KC.NO,
KC.LALT, KC.LGUI, KC.LCTL, KC.LSFT, KC.NO, KC.MS_LT, KC.MS_DN, KC.MS_UP, KC.MS_RT, KC.NO,
...
KC.LALT, KC.LGUI, KC.LCTL, KC.LSFT, KC.NO, KC.MPRV, KC.VOLD, KC.VOLU, KC.MNXT, KC.PS_TOG,
...
KC.SCLN, KC.N4, KC.N5, KC.N6, KC.EQL, KC.NO, KC.LSFT, KC.LCTL, KC.LGUI, KC.LALT,
...
KC.COLN, KC.DLR, KC.PERC, KC.CIRC, KC.PLUS, KC.NO, KC.LSFT, KC.LCTL, KC.LGUI, KC.LALT,
...
KC.F11, KC.F4, KC.F5, KC.F6, KC.SLCK, KC.NO, KC.LSFT, KC.LCTL, KC.LGUI, KC.LALT,
